		...
		<div id="content">
			...
			<div class="container-fluid">
				...
				<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<?php $this->load->view('keuangan/create') ?>
				</div>
				<!-- end modal tambah -->
				<div class="card shadow mb-4">
					<div class="card-header py-3 d-flex justify-content-between">
						<h6 class="m-0 font-weight-bold text-primary d-inline-block pt-2">Laporan Keuangan Tahunan</h6>
							...
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<a href="<?php echo base_url('keuangan/edit/' .$row->id) ?>" class="btn btn-warning btn-sm">
										Edit
										</a>
										<a href="<?php echo base_url('keuangan/delete/' .$row->id) ?>" class="btn btn-danger btn-sm">Hapus</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
